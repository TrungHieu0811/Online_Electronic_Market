...
public class OrderController {
    ...
    public ResponseEntity<?> cancelOrder(Principal principal, @PathVariable Integer id) {
        try {
            orderService.cancelOrder(principal.getName(), id);
            return ResponseEntity.ok(Map.of("message", "Your order has been successfully cancelled"));
        } catch (Exception e) {
