...
public class ProductReviewServiceImpl implements ProductReviewService {
    ...
    public ProductReview create(CreateReviewDto dto) {
        ...
        if (dto.getComment() != null && !dto.getComment().isBlank()) {
            ...
            try {
                ...
                modRequest.setContent(dto.getComment());
                modRequest.setRating(dto.getRatingScore());
                modRequest.setProductId(dto.getProductId());
                modRequest.setUserId(dto.getUserId());
    ...
    public ProductReview update(Integer reviewId, CreateReviewDto dto) {
        ...
        if (dto.getComment() != null && !dto.getComment().isBlank()) {
            ...
            try {
                ...
                modRequest.setContent(dto.getComment());
                modRequest.setRating(dto.getRatingScore());
                modRequest.setProductId(review.getProduct().getId());
                modRequest.setUserId(dto.getUserId());
    ...
    public ProductReviewSentimentSummaryDto getSentimentSummary(Integer productId) {
        ...
        ProductReviewSentimentSummaryDto dto = new ProductReviewSentimentSummaryDto();
        ...
        dto.setOverallSentiment(overall);

        return dto;
    }

    @Override
    public List<String> getApprovedReviewComments(Integer productId) {
        return reviewRepository
                .findByProductIdAndStatus(productId, ProductReview.ReviewStatus.APPROVED)
                .stream()
