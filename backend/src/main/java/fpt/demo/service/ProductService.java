...
public interface ProductService {
  ...
  Page<Product> filterProducts(ProductFilterRequestDto request, int page, int size);

  // Admin & Search
  Page<Product> search(String name, Integer groupId, Double min, Double max, int page, int size);
