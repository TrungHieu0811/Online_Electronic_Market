		...
		<section className="mb-8 rounded-2xl bg-white p-8 shadow-[0px_12px_32px_rgba(0,26,64,0.08)]">
			<div className="flex flex-col gap-8 md:flex-row">
				...
				<div className="flex-grow">
					...
					<div className="mb-8">
						<p className="mb-4 text-sm font-bold uppercase tracking-tight text-slate-600">Overall Rating</p>
						<StarRatingInput value={review?.rating || 0} onChange={(value) => onRatingChange(item.id, value)} />
					</div>

					<div className="mb-2">
						<label className="mb-3 block text-sm font-bold uppercase tracking-tight text-slate-600">Review Details</label>
						<textarea
