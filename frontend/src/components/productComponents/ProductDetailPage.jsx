			...
			<div className="max-w-6xl mx-auto px-4 py-6">
				...
				<nav className="flex items-center gap-1.5 text-xs text-gray-400 mb-6 flex-wrap">
					{crumbs.filter(Boolean).map((c, i, arr) => (
						<React.Fragment key={i}>
							<span
								className={
									i === arr.length - 1 ? 'text-gray-600 font-medium truncate max-w-xs' : 'hover:text-gray-600 cursor-pointer'
								}
							>
								{c}
							</span>
				...
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-10 mb-12">
					...
					<div className="flex flex-col gap-4">
						...
						{/* Title */}
						<h1 className="text-2xl font-bold text-gray-900 leading-snug">{variantName}</h1>
					...
					<div className="mb-12">
						...
						<div className="border border-gray-200 rounded-2xl overflow-hidden">
							{attributes.map((attr, i) => (
								...
								>
									<span className="w-36 flex-shrink-0 font-medium text-gray-700">{attr.name}</span>
