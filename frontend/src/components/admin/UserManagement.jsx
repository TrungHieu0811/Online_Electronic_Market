        ...
        <div className='flex min-h-screen bg-[#f8f6f6]'>
            ...
            <main className='flex-1 min-w-0 flex flex-col'>
                ...
                <div className='w-full max-w-7xl mx-auto p-8'>
                    <div className='mb-8'>
                        <h1 className='text-5xl/[1.1] font-black tracking-tight text-slate-950'>
                            User Directory
                        </h1>
                        <p className='mt-3 text-xl text-slate-500'>
                            View and manage all registered customer accounts and administrator
                            roles.
                        </p>
                    </div>
                                        ...
                                        users.map((user) => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    <td className='px-6 py-5'>
                                                        <div
                                                            className={`flex items-center gap-2 text-xs font-semibold ${statusStyle.text}`}
                                                        >
                                                            <span
                        ...
                        <div className='flex items-center justify-between border-t border-slate-200 bg-slate-50/70 px-6 py-4'>
                            <p className='text-xs font-medium text-slate-500'>
                                ...
                                {pagination.totalElements === 0
                                    ? 0
                                    : pagination.currentPage * size + 1}{' '}
                                to{' '}
                                {Math.min(
                                    (pagination.currentPage + 1) * size,
                            ...
                            <div className='flex items-center gap-2'>
                                ...
                                <button
                                    disabled={
                                        ...
                                        Math.max((pagination.totalPages || 1) - 1, 0)
                                    }
                                    onClick={() =>
                                        setPage((prev) =>
                                            Math.min(
                    ...
                    <div className='mt-8 grid grid-cols-1 gap-6 md:grid-cols-3'>
                        ...
                        <div className='flex items-center gap-4 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm'>
                            ...
                            <div>
                                ...
                                <p className='text-2xl font-black text-slate-950'>
                                    {loadingStats ? '...' : stats.blockedUsers}
                                </p>
                            </div>
                        </div>
                    </div>
