...
class _ChatAIScreenState extends State<ChatAIScreen> with TickerProviderStateMixin {
  ...
  final List<Map<String, dynamic>> _messages = [
    {"sender": "bot", "text": "Hello! I'm ElectroMart AI. How can I help you today?"}
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("ELECTROMART AI", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
...
Widget _renderMessage(String text, bool isUser) {
  ...
  Widget _buildProductCard(String slug, String imageUrl, String name, String price) {
    return Container(
      width: 280,
        ...
        children: [
          ClipRRect(
            ...
            child: Image.network(
              ...
              errorBuilder: (context, error, stackTrace) => const Icon(Icons.image, size: 70, color: Colors.grey),
            ),
          ),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 8),
                ElevatedButton(
                  onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (c) => ProductDetailPage(slug: slug))),
...
class _DotIndicatorState extends State<_DotIndicator> with SingleTickerProviderStateMixin {
  ...
  @override
  Widget build(BuildContext context) {
    return FadeTransition(opacity: _animation, child: Container(width: 6, height: 6, decoration: const BoxDecoration(color: Colors.grey, shape: BoxShape.circle)));
  }
}